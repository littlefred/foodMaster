 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://soap.workshop.java.simplon.co/}foodAttribute" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetFoodAttributeListByNameResponse {
    ...
    protected List<FoodAttribute> _return;
     ...
     * 
     */
    public List<FoodAttribute> getReturn() {
        if (_return == null) {
            _return = new ArrayList<FoodAttribute>();
        }
        return this._return;
    }
